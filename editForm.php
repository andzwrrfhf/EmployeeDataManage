...
if (!empty($_GET['editDataMhs'])) {
  $nomor = $_GET['editDataMhs'];
  $query = $mysqli->query("SELECT * FROM mahasiswa WHERE nomor='$nomor'");
  ...
  <div class="body-container">
    ...
    <div class="form-container">
      <form method="post" action="edit.php">
        <input type="hidden" name="editDataKaryawan" value="<?php if (isset($data)) echo $data['nomor']; ?>" />
        <div class="form1">
          <p class="label">No.</p>
        ...
        <input class="btn-edit" type="submit" name="submitEdit" value="Edit Data">
      </form>
    </div>
</body>
